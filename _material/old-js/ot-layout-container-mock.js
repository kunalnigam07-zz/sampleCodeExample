...
'silver', 'teal', 'white', 'black', 'aqua', 'yellow', 'blue'];
var coltrack = -1;
	...
	return {
		...
		layout: function(){
			...
			for (i=0; i < count; i++) {
                ...
                //var parent = $('#' + containerId).children(':visible:eq(' + i + ')')[0];
				...
				child.height = targetHeight;//console.log(parent);
			};
		},
		/**
		...
		addStream: function(divId, publisher) {
            ...
            span.innerHTML = '<h1 style="font-size:50px;color:#ffffff;background-color:#aaaaaa">Stream: ' + divId + '</h1>';
            div.appendChild(span);
			div.setAttribute('id', divId);
			container.appendChild(div);
            container.style.backgroundColor=colors[coltrack];
